...
class AnalysisThread(QtCore.QThread):
    ...
    def __init__(self, inference, images, save_paths, ids, button):
    ...
    def run(self):
        ...
        self.inference.initial(self.callback_txt)
...
class MainUi(QtWidgets.QMainWindow):
    ...
    def init_left_ui(self):
        ...
        self.left_button_9.setText("<a href='https://shimo.im/docs/bQeGWqF6C30WBVAU/' style='color:white'>Betav0.3.0</a>")
    ...
    def init_right_ui(self):
        ...
        self.right_title = QCheckBox("AIforEye角膜溃烂智能辅助诊断系统", self)
    ...
    image: url(./res/input.png);}
        ...
        self.open_icon = QCheckBox('打开文件 (请选择眼表照)', self)  # 单选按钮
    ...
    image: url(./res/open.png);}
        ...
        self.right_layout.addWidget(self.right_button_1, 6, 0, 1, 2)
        ...
        self.right_layout.addWidget(self.right_button_2, 7, 0, 1, 2)
        ...
        self.right_layout.addWidget(self.start, 8, 0, 1, 2)
        ...
        self.right_layout.addWidget(self.proc, 9, 0, 1, 9)
    ...
    image: url(./res/loading.png);}
        ...
        self.right_layout.addWidget(self.pbar, 10, 0, 1, 9)
