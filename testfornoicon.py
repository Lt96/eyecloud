...
class MainUi(QtWidgets.QMainWindow):
    ...
    def warning(self, event):
        warn = QMessageBox.warning(self, '警告', "请选择需要诊断的图片或者文件夹", QMessageBox.Yes,
                                   QMessageBox.Yes)
    ...
    def init_left_ui(self):
        ...
        self.left_button_9.setText("<a href='https://shimo.im/docs/bQeGWqF6C30WBVAU/' style='color:white'>Beta v1.2.2</a>")
    ...
    def main(self):
        ...
        if (not (image1[0] and image1[1])):
            ...
            if (image1[0] == "dir"):
                ...
                save_paths = [
                    os.path.splitext(image.replace(image1[1], save_directory))[0] + '.pdf'
                    for image in images
                ]
                print(save_paths)
