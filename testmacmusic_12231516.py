...
'''
    ...
    def init_left_ui(self):
        ...
        self.left_button_9 = QLabel("@betav1.1", self)
    ...
    def init_right_ui(self):
        ...
        self.right_message1.setText(
            "邮箱:tangxy@sustc.edu.cn\n地址:广东省深圳市南山区南方科技大学\n合作单位:中山大学中山眼科中心")  # 联系与帮助
        self.right_layout.addWidget(self.right_message1, 0, 0, 1, 9)  # 输入栏
