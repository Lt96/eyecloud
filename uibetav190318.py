...
class MainUi(QtWidgets.QMainWindow):
    ...
    image: url(./res/3n.png);}
        ...
        self.id_icon = QCheckBox('填写ID（选填）', self)  # 单选按钮
    ...
    image: url(./res/input.png);}
        ...
        self.right_bar_widget_id_input.setValidator(QtGui.QIntValidator())
...
QCheckBox::indicator:checked:pressed {
    ...
    def printl(self):
        ...
        self.right_bar_widget_open_input.setEnabled(True)
